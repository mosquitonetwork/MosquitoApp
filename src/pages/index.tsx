...
import { Box, Container, LinkBox, SimpleGrid, LinkOverlay, Stack, Alert, Image, Link as ChakraLink, Icon } from '@chakra-ui/react';
...
export const Home = observer(() => {
  ...
  const links = [
    { text: 'GitHub |', url: 'https://github.com/mosquitonetwork' },
    { text: `${lang.t('issues')} |`, url: 'https://github.com/mosquitonetwork' },
    { text: `${lang.t('use.template')}`, url: 'https://github.com/mosquitonetwork' }
  ];

  return (
    <Container maxW='7xl'>
      <Flex justifyContent={'center'} alignItems={'center'} mt={10} flexDirection={'column'}>
        <ChakraLink href='https://mosquito.network' isExternal>
          <Image src={'images/mosquito_coin.png'} w={'100%'} />
        </ChakraLink>
        <Text mt={5}>
          Mosquito Network - {lang.t('Mosquito')}
        </Text>
        <Flex mt={5}>
          {
            links.map(link => {
